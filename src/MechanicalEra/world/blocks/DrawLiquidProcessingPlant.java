...
public class DrawLiquidProcessingPlant extends DrawBlock {
    public Color plantColor = Color.valueOf("020202");
    public Color plantColorLight = Color.valueOf("1a1919");
    public Color bottomColor = Color.valueOf("494949");
